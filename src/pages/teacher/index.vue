    ...
    <el-container class="kingorld-container" style=" border: 1px solid #eee">
      <el-aside style="width:150px">
        <el-menu default-active="1">
          ...
          <el-menu-item index="2" @click="showEquipStatus">
            <i class="el-icon-s-order icons"></i>
            <span slot="title" class="aside-title">设备状况</span>
          </el-menu-item>

          <el-submenu index="3">
            <template slot="title">
              <i class="el-icon-coin icons"></i>
              <span class="aside-title">我的审批</span>
            </template>
            <el-menu-item-group>
              <el-menu-item index="3-1" class="ui-menu-item aside-title" @click="showChecked">未审核</el-menu-item>
              <el-menu-item index="3-2" class="ui-menu-item aside-title" @click="showCheck">已审核</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
